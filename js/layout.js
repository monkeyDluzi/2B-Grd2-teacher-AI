const headerHTML = `
    <div class="header-container">
      ...
      <nav class="nav" role="navigation" aria-label="Main navigation">
        <a href="../html/main.html" class="nav-link" aria-label="Navigate to home page">Home</a>
        <a href="../html/about.html" class="nav-link" aria-label="Navigate to About us page">About us</a>
      </nav>
    </div>
`;
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Check if the current file name is dashboard.html or practice.html
    const isDashboardPage = window.location.pathname.includes("dashboard.html") || 
                           window.location.pathname.includes("practice.html");

    if (headerContainer) {
        // Use dashboard template if on dashboard or practice page, else use regular template
        headerContainer.innerHTML = isDashboardPage ? headerHTMLDashboard : headerHTML;
    }

    if (footerContainer) {
        // Use dashboard template if on dashboard or practice page, else use regular template
        footerContainer.innerHTML = isDashboardPage ? footerHTMLDashboard : footerHTML;
    }
});
